...
public class CodeGenerator {
    public static void main(String[] args) throws Exception {
        ...
        StrategyConfig strategy = new StrategyConfig.Builder()
                .addInclude("access_record","access_record_history",
                        "asset","auth_white_ip","bill",
                        "ip_source","mitm_script","order_rate_bill",
                        "product","product_source","recharge_record",
                        "user_order","user_order_current_bandwidth")
