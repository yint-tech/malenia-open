package cn.iinti.malenia2.service.proxy.utils;

import cn.iinti.malenia2.service.base.trace.Recorder;
import cn.iinti.malenia2.service.proxy.core.IpAndPort;
import cn.iinti.malenia2.service.proxy.core.inbound.handlers.RelayHandler;
...
public class NettyUtil {
    ...
    public static void replay(Channel inbound, Channel outbound, Recorder recorder) {
        outbound.pipeline().addLast(new RelayHandler(inbound, "replay-outbound:", recorder));
        inbound.pipeline().addLast(new RelayHandler(outbound, "replay-inbound:", recorder));
    }
