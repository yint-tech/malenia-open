...
@Getter
@Setter
@TableName("access_record_history")
@Schema(name = "AccessRecordHistory", description = "用户访问日志备份(存放历史记录)")
public class AccessRecordHistory extends EntityBase implements Serializable {
